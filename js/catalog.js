;(function(){
    var catalogSection = document.querySelector('.section__catalog');
    ...
    catalogNav.addEventListener('click', function(e) {
        var target = e.target; 
        var item = myLib.closesItemByClass(target,'catalog__nav-btn');
        ...
        var previousBtnActive = catalogNav.querySelector('.catalog__nav-btn.is-active');
